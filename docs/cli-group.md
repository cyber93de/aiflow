...
nav_order: 4
has_children: true
description: "The aiflow CLI: commands, configuration, remote hosts (GitHub, GitLab, Bitbucket, Forgejo, Gitea), Claude access, Ollama local models, context7, and MCP servers."
---
...
- **[Models & context7](models)** — Claude API key vs OAuth, **Ollama** local models, adding more
  models via claude-code-router, and **context7** live library docs.
